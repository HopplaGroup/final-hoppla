        ...
        <Body style={main}>
            <Container style={container}>
                <Section style={box}>
                    ...
                    <Text style={secParagraph}>{secondaryMessage}</Text>
                    ...
                    <Hr style={hr} />
                    <Text style={footer}>
                        დამატებითი კითხვების შემთხვევაში მოგვმართეთ სოციალურ
                        ქსელების დახმარებით
                        <a href="https://www.facebook.com/hoppla.ge">
                            {" "}
                            Facebook
                        </a>{" "}
                        or
                        <a href="https://www.instagram.com/hoppla.ge/">
                            {" "}
                            Instagram
                        </a>
                    </Text>
