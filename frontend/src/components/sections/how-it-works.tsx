        ...
        <div className="relative mt-12 lg:mt-20">
          ...
          <div className="relative grid grid-cols-1 text-center gap-y-12 md:grid-cols-3 gap-x-12 ">
            <div className="">
              ...
              <p className="mt-2 text-base ">{m.lime_keen_swan_hope()}</p>
            </div>
            <div>
              ...
              <p className="mt-2 text-base ">{m.tame_still_horse_enchant()}</p>
            </div>
            <div>
              <div className="flex items-center justify-center w-12 h-12 mx-auto text-primary-foreground bg-primary rounded-full">
              ...
              <p className="mt-2 text-base ">{m.fuzzy_mad_mallard_hunt()}</p>
            </div>
          </div>
        </div>
      </div>
