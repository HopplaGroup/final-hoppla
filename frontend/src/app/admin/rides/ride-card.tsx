  ...
  function onCancelRide() {
    ...
    cancelRide({
      ...
      if (res.success) {
        ...
        toast.success(m.tiny_royal_carp_honor());
      } else {
        toast.error(m.tasty_fair_parakeet_tap());
      }
    });
  }
      ...
      <div className="flex items-center justify-between w-full space-x-4">
        <div className="flex items-center gap-2">
          ...
          <div className="">
            ...
            <p className="text-sm font-medium text-gray-900 truncate dark:text-white">
              {PLACES.find((place) => place.osm === ride.from)?.name.en +
                " -> " +
                PLACES.find((place) => place.osm === ride.to)?.name.en}
            </p>
