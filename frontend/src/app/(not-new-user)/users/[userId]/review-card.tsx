      ...
      <div className="p-5">
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-2">
            <Link
              href={`/users/${
                review.$optimistic ? loggedUser?.id : review.author.id
              }`}
            >
              <img
                src={
            ...
            <div>
              <h3 className="font-medium">
                {review.$optimistic ? loggedUser?.name : review.author.name}
              </h3>
              <div className="flex items-center gap-2">
          ...
          {!review.$optimistic && review.author.id === loggedUser?.id && (
            <DropdownMenu>
              ...
              <DropdownMenuContent>
                <DropdownMenuItem
                  ...
                  onClick={() => deleteReview({ where: { id: review.id } })}
                >
                  <Trash size={18} />
                  Delete
                </DropdownMenuItem>
